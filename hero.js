...
function Hero(name, role) {
	 ...
	 CalculateAttributes(this); // this function updates attributes each time player does something. Called once during character creation to update attributes initially.
}
